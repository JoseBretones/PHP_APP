...
$sql = "INSERT INTO alojamiento (nombre,direccion,localidad,ciudad,cp,foto,precio) VALUES ('Alojamientos Rurales Villa Verde','C/Sierra de Cazorla','Lepe','Huelva',41076,'alojamiento1.jpg',120)";
...
/////////////////////////////////////////////////////////////////////
$sql = "INSERT INTO alojamiento (nombre,direccion,localidad,ciudad,cp,foto,precio)VALUES ('Casa Rural Villa Cangrejo','C/Lujana nº5','Marbella','Málaga',43097,'alojamiento2.jpg',100)";
if(mysqli_query($db,$sql)){
    echo "Fila añadida a la tabla alojamiento </br>";
}else{
    echo "Error al ejecutar consulta " . mysqli_error($db)."</br>";
...
////////////////////////////////////////////////////////////////////
$sql = "INSERT INTO alojamiento (nombre,direccion,localidad,ciudad,cp,foto,precio)VALUES ('Cortijo Bigotes','C/Chulilla nº12','Carmona','Sevilla',41089,'alojamiento3.jpg',140)";
if(mysqli_query($db,$sql)){
    echo "Fila añadida a la tabla alojamiento </br>";
}else{
    echo "Error al ejecutar consulta " . mysqli_error($db)."</br>";
...
////////////////////////////////////////////////////////////////////
$sql = "INSERT INTO alojamiento (nombre,direccion,localidad,ciudad,cp,foto,precio)VALUES ('Casa Palmera Turismo Rural','El Arrabal','Chelva','Valencia',42065,'alojamiento4.jpg',160)";
if(mysqli_query($db,$sql)){
    echo "Fila añadida a la tabla alojamiento </br>";
}else{
    echo "Error al ejecutar consulta " . mysqli_error($db)."</br>";
...
////////////////////////////////////////////////////////////////////
$sql = "INSERT INTO alojamiento (nombre,direccion,localidad,ciudad,cp,foto,precio)VALUES ('Apartamentos Rurales Pajuzo','C/La cuesta nº6','Castille de la Cuesta','Sevilla',41089,'alojamiento5.jpg',60)";
if(mysqli_query($db,$sql)){
    echo "Fila añadida a la tabla alojamiento </br>";
}else{
    echo "Error al ejecutar consulta " . mysqli_error($db)."</br>";
...
////////////////////////////////////////////////////////////////////
$sql = "INSERT INTO alojamiento (nombre,direccion,localidad,ciudad,cp,foto,precio)VALUES ('Casa Rural la Candela de la Murtera','C/Paloma nº2','Palomares del Río','Sevilla',41089,'alojamiento6.jpg',80)";
if(mysqli_query($db,$sql)){
    echo "Fila añadida a la tabla alojamiento </br>";
}else{
    echo "Error al ejecutar consulta " . mysqli_error($db)."</br>";
...
////////////////////////////////////////////////////////////////////
$sql = "INSERT INTO alojamiento (nombre,direccion,localidad,ciudad,cp,foto,precio)VALUES ('Casa Taure Turismo Rural','C/El quijote','Almensilla','Sevilla',41032,'alojamiento7.jpg',75)";
if(mysqli_query($db,$sql)){
    echo "Fila añadida a la tabla alojamiento </br>";
}else{
    echo "Error al ejecutar consulta " . mysqli_error($db)."</br>";
...
////////////////////////////////////////////////////////////////////
$sql = "INSERT INTO alojamiento (nombre,direccion,localidad,ciudad,cp,foto,precio)VALUES ('Villa Calistro','C/norte nº12','Gallegiño','Galicia',43098,'alojamiento8.jpg',135)";
if(mysqli_query($db,$sql)){
    echo "Fila añadida a la tabla alojamiento </br>";
}else{
    echo "Error al ejecutar consulta " . mysqli_error($db)."</br>";
...
////////////////////////////////////////////////////////////////////
$sql = "INSERT INTO alojamiento (nombre,direccion,localidad,ciudad,cp,foto,precio)VALUES ('Casa Valle del Turia','C/La esquina nº1','Andurria','Barcelona',41022,'alojamiento9.jpg',50)";
if(mysqli_query($db,$sql)){
    echo "Fila añadida a la tabla alojamiento </br>";
}else{
    echo "Error al ejecutar consulta " . mysqli_error($db)."</br>";
